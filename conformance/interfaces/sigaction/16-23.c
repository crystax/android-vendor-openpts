...
* -> child registers a handler for SIGURG with SA_RESTART, then waits for the semaphore
* -> parent kills the child with SIGURG, then post the semaphore.
