...
* -> child registers a handler for SIGXFSZ with SA_RESTART, then waits for the semaphore
* -> parent kills the child with SIGXFSZ, then post the semaphore.
