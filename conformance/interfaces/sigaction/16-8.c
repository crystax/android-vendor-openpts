...
* -> child registers a handler for SIGILL with SA_RESTART, then waits for the semaphore
* -> parent kills the child with SIGILL, then post the semaphore.
