...
* -> child registers a handler for SIGTTOU with SA_RESTART, then waits for the semaphore
* -> parent kills the child with SIGTTOU, then post the semaphore.
